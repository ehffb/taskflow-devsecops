...
Esperar o termino do desenvolvimento do software para pensar em segurança é arriscado, pois corrigir falhas de segurança quando se esta no final do projeto é muito mais caro e irá ter o retrabalho. E como as equipes tem prazos para entrega do software, evitar isto é importante.# Teste de Pull Request para validar o CI
